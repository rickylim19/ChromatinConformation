...
\begin{table}[h!]
  ...
  \begin{tabular}{ | m{5cm} | c | m{5cm} | c | }
    ...
    Info & Dist & Info & Dist\\ \hline
      ...
      %row1
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_direct[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_direct[1,'Binding.Range']}
        \item P.value: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_direct[1,'P.value']}
        \item Rank: 1
      \end{itemize}
      &
    ...
    &
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_indirect[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_indirect[1,'Binding.Range']}
        \item P.value: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_compSorted_dist50kb_indirect[1,'P.value']}
        \item Rank: 1
      \end{itemize}
    &
    \begin{minipage}{.2\textwidth}
