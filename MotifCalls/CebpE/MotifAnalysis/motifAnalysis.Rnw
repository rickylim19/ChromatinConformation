...
Here, we applied local clustering following the component calls by mixture models. 
...
\subsection{Local Clustering: 4 Components-Mixture Negative Binomial Models}
...
\begin{figure}[!htp]
    \centering
    \subfloat{\includegraphics[width = 2 in, height = 3 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_NBM_comp4_dist3kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 3 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_NBM_comp4_dist5kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 3 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_NBM_comp4_dist8kb_SinglePeakFilteredOut_countCluster.pdf}}
    \\
    \subfloat{\includegraphics[width = 2 in, height = 3 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_NBM_comp4_dist20kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 3 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_NBM_comp4_dist50kb_SinglePeakFilteredOut_countCluster.pdf}}
...
\subsection{Local Clustering: Log-Transformed 4 Components-Gaussian Mixture Models}
...
\begin{figure}[!htp]
    \centering
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp4_dist3kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp4_dist5kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp4_dist8kb_SinglePeakFilteredOut_countCluster.pdf}}
    \\
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp4_dist20kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp4_dist50kb_SinglePeakFilteredOut_countCluster.pdf}}
    \caption{The Number of Peaks (percentage) in Clusters without Single Peaks: 4 Components-GMM}
    \label{fig:numPeaksNoSingleCell4comp}
\end{figure}
\clearpage
...
\subsection{Local Clustering: Log-Transformed 5 Components-Gaussian Mixture Models}
...
\begin{figure}[!htp]
    \centering
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp5_dist3kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp5_dist5kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp5_dist8kb_SinglePeakFilteredOut_countCluster.pdf}}
    \\
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp5_dist20kb_SinglePeakFilteredOut_countCluster.pdf}}
    \subfloat{\includegraphics[width = 2 in, height = 2 in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_comp5_dist50kb_SinglePeakFilteredOut_countCluster.pdf}}
    \caption{The Number of Peaks (percentage) in Clusters without Single Peaks: 5 Components-GMM}
    \label{fig:numPeaksNoSingleCell4comp}
\end{figure}
\clearpage
...
%      %row1
%      \begin{itemize}
%        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_direct_comp4[1,'Name']}
%        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_direct_comp4[1,'Binding.Range']}
%        \item P.value: \textasciitilde \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_direct_comp4[1,'P.value']}
%        \item Rank: 1
%      \end{itemize}
%      &
%    \begin{minipage}{.2\textwidth}
%      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_NBM_BiclusterAssignment_SinglePeakFilteredOut_compSorted4_dist50kb_direct/V$CEBPB_02}
%    \end{minipage}
%    &
%      \begin{itemize}
%        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_indirect_comp4[1,'Name']}
%        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_indirect_comp4[1,'Binding.Range']}
%        \item P.value: \textasciitilde \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_NBM_compSorted_dist50kb_indirect_comp4[1,'P.value']}
%        \item Rank: 1
%      \end{itemize}
%    &
%    \begin{minipage}{.2\textwidth}
%      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_NBM_BiclusterAssignment_SinglePeakFilteredOut_compSorted4_dist50kb_indirect/V$CEBPB_02}
%    \end{minipage}
%    \\ \hline
%
%  \end{tabular}
%  \caption{CebpE ChIPseq in BM: CentDist Motif Discovery in 4-Component NBM}
%  \label{CebpECentdist}
%\end{table}
...
\begin{table}[h!]
  ...
  \begin{tabular}{ | m{5cm} | c | m{5cm} | c | }
    ...
    Info & Dist & Info & Dist\\ \hline
      ...
      %row1
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp4[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp4[1,'Binding.Range']}
        \item P.value: \textasciitilde\Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp4[1,'P.value']}
        \item Rank: 1
      \end{itemize}
      &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted4_dist50kb_direct/V$CEBPB_02.png}
    \end{minipage}
    &
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[1,'Binding.Range']}
        \item P.value: \textasciitilde\Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[1,'P.value']}
        \item Rank: 1
      \end{itemize}
    &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted4_dist50kb_indirect/V$CEBPB_02.png}
    \end{minipage}
    \\ \hline

  \end{tabular}
  \caption{CebpE ChIPseq in BM: CentDist Motif Discovery in 4-Component GMM}
  \label{CebpECentdist}
\end{table}
...
\begin{table}[h!]
  ...
  \begin{tabular}{ | m{5cm} | c | m{5cm} | c | }
    ...
    Info & Dist & Info & Dist\\ \hline
      ...
      %row1
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp5[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp5[1,'Binding.Range']}
        \item P.value: \textasciitilde\Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_direct_comp5[1,'P.value']}
        \item Rank: 1
      \end{itemize}
      &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted5_dist50kb_direct/V$CEBPB_02.png}
    \end{minipage}
    &
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[1,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[1,'Binding.Range']}
        \item P.value: \textasciitilde\Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[1,'P.value']}
        \item Rank: 1
      \end{itemize}
    &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted5_dist50kb_indirect/V$CEBPB_02.png}
    \end{minipage}
    \\ \hline

  \end{tabular}
  \caption{CebpE ChIPseq in BM: CentDist Motif Discovery in 5-Component GMM}
  \label{CebpECentdist}
\end{table}

Note that CTCF was found only in indirect bindings not in direct bindings in all cluster distances ranging from 3kb to 50kb.

\begin{table}[h!]
  \centering
    \multicolumn{2}{c}{Indirect 4-Comp GMM}
    \multicolumn{2}{c}{Indirect 5-Comp GMM} \\
    \cline{1-2}
    \cline{2-4}
  \begin{tabular}{ | m{5cm} | c | m{5cm} | c | }
    \hline
    Info & Dist & Info & Dist\\ \hline
      ...
      %row1
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[6,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[6,'Binding.Range']}
        \item P.value: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp4[6,'P.value']}
        \item Rank: 6
      \end{itemize}
      &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted4_dist50kb_indirect/V$jaspar_CTCF.png}
    \end{minipage}
    &
      \begin{itemize}
        \item Name: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[6,'Name']}
        \item Binding.Range: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[6,'Binding.Range']}
        \item P.value: \Sexpr{Koeffler_BM_ChIPseq_CebpE_Bicluster_GMM_compSorted_dist50kb_indirect_comp5[6,'P.value']}
        \item Rank: 6
      \end{itemize}
    &
    \begin{minipage}{.2\textwidth}
      \includegraphics[width=30mm, height=30mm]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/Output/CentDist/Koeffler_BM_CebpE_GMM_BiclusterAssignment_SinglePeakFilteredOut_log_compSorted5_dist50kb_indirect/V$jaspar_CTCF.png}
    \end{minipage}
    \\ \hline

  \end{tabular}
  \caption{CTCF ChIPseq in BM indirect: CentDist Motif Discovery in 4- and 5-Component GMM}
  \label{CebpECentdist}
\end{table}
...
\section{Centrimo Motif Results for Log-Transformed ChIPseq}

\subsection{Centrimo Motif Results from 4-Component GMM}
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 6in, height = 6in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_BoxplotProfile_compSorted4.pdf}}
    ...
    \label{fig:boxplotProfileComp4}
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group1_compSorted4_ProfileMatrix.png}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group4_compSorted4_ProfileMatrix.png}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CTCF_centrimo.png}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CEBPB_centrimo.png}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CTCF_Centdist.jpg}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CEBPB_02_Centdist.jpg}}
    \caption{Heatmaps of ChIP Profiles in 4-component GMM group1 (Top Left), and group4 (Top Right). {\color{red}Red} and {\color{black}Black} represents positive and zero values, respectively. Below are the motif distributions for CTCF(Left) and CEBPB(Right) discovered by ChIPmeme.}
    \label{fig:sorted4CompBoxplot}
\end{figure}
\clearpage


\subsection{Motif ChipSeq Distribution of CEBPB and CTCF: 4-Component GMM}
<<>>=
...
\subsection{Centrimo Motif Results from 5-Component GMM}
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 6in, height = 6in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/ComponentAnalysis/figs/Koeffler_BM_CebpE_BoxplotProfile_compSorted5.pdf}}
    \caption{Boxplots of ChIP Profiles in 4-component GMM group1 ({\color{red}Red)}, group2({\color{green}Green}), group3 ({\color{yellow}Yellow}), group4 ({\color{blue}Blue}), group5 ({\color{cyan}Cyan})}
    \label{fig:boxplotProfileComp5}
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group1_compSorted5_ProfileMatrix.png}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group5_compSorted5_ProfileMatrix.png}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CTCF_centrimo.png}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CEBPB_centrimo.png}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CTCF_Centdist_group1_comp5.jpg}}
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/MotifCalls/CebpE/MotifAnalysis/figs/CEBPB_02_Centdist_group5_comp5.jpg}}
    \caption{Heatmaps of ChIP Profiles in 5-component GMM group1 (Top Left), and group5 (Top Right). {\color{red}Red} and {\color{black}Black} represents positive and zero values, respectively. Below are the motif distributions for CTCF(Left) and CEBPB(Right) discovered by ChIPmeme.}
    \label{fig:sorted4CompBoxplot}
\end{figure}
\clearpage
