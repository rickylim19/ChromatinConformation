...
Here is the quick insight on Cebp Protein from \href{https://pubmedylicious.appspot.com/result/5073520312713216}{Pubmedylicious}.
...
\begin{figure}[!htbp]
    \includegraphics[width=5in, height=2.5in]{figs/Koeffler_BM_CebpE_CountChipSeqPeaks.pdf}
    \\
    \includegraphics[width=5in, height=2.5in]{figs/Koeffler_BM_CebpE_CountChipSeqPeaks_log.pdf}
    \caption{Distibution of ChIPseq Peak Pileup Scores.}
    \label{fig:DistributionChipPeak}
\end{figure}
\clearpage

\subsection{Check the Normality after Log Transformation}
...
\begin{figure}[!htbp]
    \includegraphics[width=3in, height=4in]{figs/Koeffler_BM_CebpE_qqplot.pdf}
    \includegraphics[width=3in, height=4in]{figs/Koeffler_BM_CebpE_log_qqplot.pdf}
    \caption{Check Normality of ChIPseq Peak Scores}
    \label{fig:qqplotChipPeak}
\end{figure}

\clearpage
\section{CebpE Profile}
\subsection{4 Component-GMM on Log Transformed}
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 6in, height = 4in]{figs/Koeffler_BM_CebpE_BoxplotProfile_compSorted4.pdf}}
...
\begin{figure}[H]
    ...
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group2_compSorted4_ProfileMatrix.png}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group3_compSorted4_ProfileMatrix.png}}
    ...
    \caption{Heatmaps of ChIP Profiles in 4-component GMM group1 (Top Left), group2 (Top Right), group3 (Below Left), and group4 (Below Right). {\color{red}Red} and {\color{black}Black} represents positive and zero values, respectively. }
    \label{fig:sorted4CompBoxplot}
\end{figure}
\clearpage

\subsection{5 Component-GMM on Log-Transformed}
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 6in, height = 4in]{figs/Koeffler_BM_CebpE_BoxplotProfile_compSorted5.pdf}}
    \caption{Boxplots of ChIP Profiles in 5-component GMM group1 ({\color{red}Red)}, group2({\color{green}Green}), group3 ({\color{yellow}Yellow}), group4 ({\color{blue}Blue}), and group5 ({\color{cyan}Cyan}).}
    \label{fig:boxplotProfile}
\end{figure}
\clearpage
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 2in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group1_compSorted5_ProfileMatrix.png}}
    \subfloat{\includegraphics[width = 2in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group2_compSorted5_ProfileMatrix.png}}
    \subfloat{\includegraphics[width = 2in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group3_compSorted5_ProfileMatrix.png}}
    \\
    \subfloat{\includegraphics[width = 2in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group4_compSorted5_ProfileMatrix.png}}
    \subfloat{\includegraphics[width = 2in, height = 3in]{/home/ricky/Rlim/ChromatinConformation/ComponentCalls/CebpE/Output/Koeffler_BM_CebpE_GMM_ModelAssignment_log_group5_compSorted5_ProfileMatrix.png}}
    \caption{Heatmaps of ChIP Profiles in 5-component GMM group1 (Top Left), group2 (middle), group3 (Top Right), group4 (Below Left), and group5 (Below Right). {\color{red}Red} and {\color{black}Black} represents positive and zero values, respectively. }
    \label{fig:sorted5CompBoxplot}
\end{figure}
\clearpage
...
\begin{figure}[!htp]
    ...
    %\subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_normalModel_log.pdf}}
...
\subsection{GMMs Fitted on Log-Transformed ChIP-seq Peaks}
...
\subsection{Fitted GMMs Visualized on ChIP-seq Log Distributions}
...
\begin{figure}[!htp]
    \centering
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp2.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp3.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp4.pdf}}
    \\
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp5.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp6.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp7.pdf}}
    \\
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp8.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp9.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp10.pdf}}
    \caption{ChIPseq Log-Transformed Peaks Fit with GMMs Ranging from Two to Ten Components}
    \label{fig:FittingChIPGMMLog}
\end{figure}
\clearpage
...
\section{empirical vs Estimate Distribution}
Here, we assess for the possible overfit of our fitting mixture models by comparing the empirical and overal estimate distribution from the mixture models.
...
\subsection{Comparing Density Estimates: Empirical vs Gaussian Mixture (GMM) on Log-transformed ChIPseq}
\begin{figure}[!htp]
    \centering
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp2_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp3_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp4_empVsModel.pdf}}
    \\
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp5_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp6_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp7_empVsModel.pdf}}
    \\
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp8_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp9_empVsModel.pdf}}
    \subfloat{\includegraphics[width = 2in]{figs/Koeffler_BM_CebpE_GMM_ModelVisualization_log_comp10_empVsModel.pdf}}
    \caption{Comparing Density Estimates: Empirical Vs Gaussian Mixture on Log Transformed ChIPseq-Data}
    \label{fig:empVsgauss}
\end{figure}
\clearpage
...
\subsection{Stability of the Distribution of Component Assignments: GMMs Log-Transformed}
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 1.3in, height = 1in]{figs/Koeffler_BM_CebpE_CompFreqTable_2_comp_GMM_log.pdf}}
    \subfloat{\includegraphics[width = 1.3in, height = 1in]{figs/Koeffler_BM_CebpE_CompFreqTable_3_comp_GMM_log.pdf}}
    \subfloat{\includegraphics[width = 1.3in, height = 1in]{figs/Koeffler_BM_CebpE_CompFreqTable_4_comp_GMM_log.pdf}}
    \\
    \subfloat{\includegraphics[width = 1.3in, height = 1in]{figs/Koeffler_BM_CebpE_CompFreqTable_5_comp_GMM_log.pdf}}
    \subfloat{\includegraphics[width = 1.3in, height = 1in]{figs/Koeffler_BM_CebpE_CompFreqTable_6_comp_GMM_log.pdf}}
    \caption{Component Frequency over Three Different Runs: GMM on Log Transformed ChIPseq}
    \label{fig:compFreqGMMLog}
\end{figure}      
...
\subsection{GMMs Model Assessment on Log Transformed ChIPseq: AIC and BIC}
...
@
\begin{figure}[H]                                                                                                   \centering
    \subfloat{\includegraphics[width = 2in, height = 3in]{figs/Koeffler_BM_CebpE_GMM_ModelAssessment_AICBIC.pdf}}
    \subfloat{\includegraphics[width = 2in, height = 3in]{figs/Koeffler_BM_CebpE_NBM_ModelAssessment_AICBIC.pdf}}
    \subfloat{\includegraphics[width = 2in, height = 3in]{figs/Koeffler_BM_CebpE_GMM_ModelAssessment_log_AICBIC.pdf}}
...
\begin{figure}[H]                                                                                                   \centering
    \subfloat{\includegraphics[width = 5in, height = 3in]{figs/Koeffler_BM_CebpE_CrossvalModelSelection.pdf}}
    \subfloat{\includegraphics[width = 5in, height = 3in]{figs/Koeffler_BM_CebpE_CrossvalModelSelection_log.pdf}}
    \caption{Log-likelihoods of different number of components of gaussian mixture models, fit to a random half of the data for training, and tested on the other half of the data for testing.}
    \label{fig:ModelCrossValidation}
\end{figure}
\clearpage
...
Here, the sorted-component GMM and NBM (Figure ~\ref{fig:SortedCompGenomicLocation}) are visualized on chr14.
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 7in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_compSorted4.pdf}}
    \\
    \subfloat{\includegraphics[width = 7in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_log_compSorted4.pdf}}
    \\
    \subfloat{\includegraphics[width = 7in, height = 2.25in]{figs/Koeffler_BM_CebpE_NBM_ModelAssignment_compSorted4.pdf}}
    \\
    \subfloat{\includegraphics[width = 7in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_log_compSorted5.pdf}}
    \caption{Mixture-4-Component GMM, log-GMM, NBM, and 5-Component log-GMM assignment on Chr14.}
    \label{fig:SortedCompGenomicLocation}
\end{figure}
\clearpage

\section{Score Distribution of Component Assignments}

The score distribution of mixture-component GMM and NBM are shown as boxplots (Figure ~\ref{fig:sortedCompBoxplot})
...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width = 3in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_compSorted4_Boxplot.pdf}}
    \subfloat{\includegraphics[width = 3in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_log_compSorted4_Boxplot.pdf}}
    \\
    \subfloat{\includegraphics[width = 3in, height = 2.25in]{figs/Koeffler_BM_CebpE_NBM_ModelAssignment_compSorted4_Boxplot.pdf}}
    \subfloat{\includegraphics[width = 3in, height = 2.25in]{figs/Koeffler_BM_CebpE_GMM_ModelAssignment_log_compSorted5_Boxplot.pdf}}
    \caption{Boxplots of ChIP Peak Scores.}
    \label{fig:sortedCompBoxplot}
\end{figure}
\clearpage
